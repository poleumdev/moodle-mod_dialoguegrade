...
require_once($CFG->dirroot . '/mod/dialoguegrade/classes/conversations_by_role.php');
...
$pageurl = new moodle_url('/mod/dialoguegrade/viewconversationsbyrole.php');
...
$list = new \mod_dialoguegrade\conversations_by_role($dialogue, $roleid, $page, \mod_dialoguegrade\dialogue::PAGINATION_PAGE_SIZE);
...
echo $roleselector;
echo $renderer->list_sortby(\mod_dialoguegrade\conversations_by_role::get_sort_options(), $sort, $direction);
