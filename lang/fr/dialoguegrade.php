...
/**
 * Strings for component 'dialogue', language 'fr', branch 'MOODLE_30_STABLE'
 *
 * @package   dialogue
...
$string['completionsend'] = 'Les étudiants doivent écrire un message ou des réponses';
$string['completionsendgroup'] = 'Messages requis';
...
$string['cannotclosedraftconversation'] = 'Vous ne pouvez pas fermer une conversation n\'ayant pas démarrer !';
...
$string['configmaxattachments'] = 'Nombre maximum de pièces-jointes.';
$string['configmaxbytes'] = 'Taille maximum par défaut des pièces-jointes pour tous les carnets de bord du site (soumis à la limite du cours et autres réglages locaux)';
$string['configtrackunread'] = 'Trouver les messages non-lus sur la page d\'accueil du cours';
...
$string['conversationcloseconfirm'] = 'Êtes-vous sûr de vouloir fermer le carnet de bord {$a} ?';
$string['conversationclosed'] = 'Le carnet de bord {$a} a été fermée';
$string['conversationdeleteconfirm'] = 'Êtes vous sûr de vouloir supprimer le carnet de bord {$a} ? Cette action est définitive';
$string['conversationdeleted'] = 'Le carnet de bord {$a} a été supprimé';
...
$string['conversationopened'] = 'Le carnet de bord a été créé';
$string['conversationopenedcron'] = 'Les conversations seront ouvertes automatiquement';
$string['conversationopenedwith'] = '<strong>1</strong> conversation ouverte avec :';
$string['conversations'] = 'Nombre';
$string['conversationsopenedwith'] = '<strong>{$a}</strong> conversations ouvertes avec :';
$string['create'] = 'Créer mon carnet de bord';
...
$string['day'] = 'jour';
$string['days'] = 'jours';
$string['deleteconversation'] = 'Supprimer le carnet de bord';
$string['deletereply'] = 'Effacer la réponse';
$string['dialogue:addinstance'] = 'Ajouter un carnet de bord';
...
$string['dialoguename'] = 'Nom du carnet de bord';
...
$string['draftconversationtrashed'] = 'Brouillons supprimés';
...
$string['errornoparticipant'] = 'Vous devez choisir un destinataire';
$string['eventconversationclosed'] = 'Carnet de bord fermé';
$string['eventconversationcreated'] = 'Carnet de bord créé';
$string['eventconversationdeleted'] = 'Carnet de bord effacé';
$string['eventconversationviewed'] = 'Carnet de bord vu';
...
$string['maxattachments_help'] = 'Ce règlage définit le nombre maximum de fichiers pouvant être attachés à un message.';
$string['maxattachmentsize'] = 'Taille maximum des pièces-jointes';
$string['maxattachmentsize_help'] = 'Ce règlage définit la taille maximale des fichiers pouvant être attachés à un message.';
$string['message'] = 'Message';
$string['messageapibasicmessage'] = '<p>{$a->userfrom} a posté un nouveau message dans le carnet de bord, avec comme sujet : <i>{$a->subject}</i>
 (Cours : {$a->coursename})<br/><br/><a href="{$a->url}">Voir dans Moodle</a></p>';
$string['messageapismallmessage'] = '{$a} a posté un nouveau message dans un carnet de bord que vous suivez';
$string['messageprovider:post'] = 'Notifications de dialogue';
$string['messages'] = 'messages';
$string['mine'] = 'Personnel';
$string['minute'] = 'minute';
$string['minutes'] = 'minutes';
$string['modulename'] = 'Carnet de bord';
$string['modulename_help'] = 'Le carnet de bord permet à un étudiant de déposer une production écrite à l\'intention d\'un enseignant/tuteur ou à un enseignant/tuteur d\'initier un échange avec un étudiant. Il s\'agit d\'une activité de suivi personnalisé. Par exemple, dans le cadre d\'un journal d\'apprentissage, un enseignant/tuteur peut demander à un étudiant de faire régulièrement un point réflexif afin d\'obtenir un feedback.';
$string['modulenameplural'] = 'Carnets de bord';
$string['month'] = 'mois';
$string['months'] = 'mois';
$string['nobulkrulesfound'] = 'Pas d\'envoi en masse trouvé !';
$string['noconversationsfound'] = 'Pas de messages trouvées !';
...
$string['pluginname'] = 'Carnet de bord';
$string['repliedby'] = '<strong>{$a->fullname}</strong> <small>a répondu</small> {$a->time} passé';
...
$string['repliedbytoday'] = '<strong>{$a->fullname}</strong> <small>a répondu à</small> {$a->time} <small>({$a->timepast}) passé</small>';
...
$string['studenttostudent'] = 'Etudiant à étudiant';
...
$string['usesearch'] = 'Utiliser la recherche pour trouver une personne avec qui partager le carnet de bord';
$string['viewconversations'] = 'Voir les messages';
$string['viewconversationsbyrole'] = 'Voir les messages par rôle';
$string['week'] = 'semaine';
$string['weeks'] = 'semaines';
$string['year'] = 'an';
$string['years'] = 'ans';
$string['saisienote'] = 'la prise en compte de cette note';
$string['saisienote_help'] = 'La note saisie écrase la précédente';
$string['dialoguegrade:addinstance'] = 'Créer une activité carnet de bord';
$string['dialoguegrade:close'] = 'Fermer son carnet de bord';
$string['dialoguegrade:closeany'] = 'Fermer n\'importe quel carnet de bord';
$string['dialoguegrade:delete'] = 'Supprimer son carnet de bord';
$string['dialoguegrade:deleteany'] = 'Supprimer n\'importe quel carnet de bord';
$string['dialoguegrade:grading'] = 'Noter un carnet de bord';
$string['dialoguegrade:multipleconversation'] = 'Partager un carnet de bord à plusieurs';
$string['dialoguegrade:open'] = 'Ouvrir un carnet de bord';
$string['dialoguegrade:receive'] = 'Réceptionner un carnet de bord';
$string['dialoguegrade:reply'] = 'Répondre à un carnet de bord';
$string['dialoguegrade:replyany'] = 'Répondre à n\'importe quel carnet de bord';
