...
$string['completionsend'] = 'students must write a message or responses';
$string['completionsendgroup'] = 'Message required';
...
$string['configmaxbytes'] = 'Default maximum size for all Log book attachments on the site (subject to course limits and other local settings)';
$string['configtrackunread'] = 'Track unread Log book messages on course homepage';
...
$string['dialoguecron'] = 'Log book cron';
$string['dialogue:addinstance'] = 'Add a Log book';
...
$string['dialoguename'] = 'Log book name';
$string['dialogueintro'] = 'Log book Introduction';
...
in with subject: <i>{$a->subject}</i> (course : {$a->coursename})
<br/><br/><a href="{$a->url}">View in Moodle</a></p>';
$string['messageprovider:post'] = 'Log book notifications';
...
$string['pluginadministration'] = 'Log book administration';
$string['pluginname'] = 'Log book';
...
$string['dialoguegrade:close'] = 'Close your log book';
$string['dialoguegrade:closeany'] = 'Close any log book';
$string['dialoguegrade:delete'] = 'Delete your log book';
$string['dialoguegrade:deleteany'] = 'Delete any log book';
$string['dialoguegrade:grading'] = 'Note a log book';
$string['dialoguegrade:multipleconversation'] = 'Share a log book to several';
$string['dialoguegrade:open'] = 'Open a log book';
$string['dialoguegrade:receive'] = 'Receive a log book';
$string['dialoguegrade:reply'] = 'Reply to a log book';
$string['dialoguegrade:replyany'] = 'Reply to any log book';
