YUI.add('moodle-mod_dialoguegrade-autocomplete', function (Y, NAME) {

M.mod_dialoguegrade = M.mod_dialoguegrade || {};
M.mod_dialoguegrade.autocomplete = {
    /** selectors **/
    SELECTORS: {
    ...
    init: function(cmid, participants) {
        ...
        this.removeimageurl = M.util.image_url('remove', 'dialoguegrade');
        ...
        this.inputnode.ac.set('source', M.cfg.wwwroot + '/mod/dialoguegrade/searchpotentials.json.php?q={query}&id=' +
